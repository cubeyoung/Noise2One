...
class TuningOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--backbone_clean', type=str, default='backbone_S_pretrain_denoising_gaussian', help='models are saved here')
        ...
        parser.add_argument('--estimator_chekpoint', type=str, default='decoder_finetune_denoising_v1_gaussian_default_2', help='models are saved here') 
        parser.add_argument('--style', type=str, default='gauss5_50', help='models are saved here')
        parser.add_argument('--eval_style', type=str, default='gauss25', help='models are saved here')
        parser.add_argument('--config', type=str, default='configs/light.yaml', help='models are saved here')
        parser.add_argument('--valid_name', type=str, default='configs/light.yaml', help='models are saved here')
        # network saving and loading parameters
        parser.add_argument('--save_latest_freq', type=int, default=5000, help='frequency of saving the latest results')
        parser.add_argument('--save_epoch_freq', type=int, default=10, help='frequency of saving checkpoints at the end of epochs')
        parser.add_argument('--valid_epoch_freq', type=int, default=1, help='frequency of saving checkpoints at the end of epochs')
